...
export class Listing extends ApiRequest {
  ...
  async findAllCurrentFeaturedListings<TResult>(
    ...
    return this.request<IFindAllCurrentFeaturedListingsParameters, TResult>("GET", "/featured_treasuries/listings/homepage_current", params, extra);
  }
  ...
  async findAllShopSectionListings<TResult>(
    ...
    return this.request<IFindAllShopSectionListingsParameters, TResult>("GET", "/shops/:shop_id/sections/:shop_section_id/listings", params, extra);
  }
